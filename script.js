...
function sub(){
  ...
  if( nama == '' || email == '' || negara == '' || tahun == '' || gender == '') {
	        if(nama == '') y += '<p><b>Namanya Di Isi Dulu Sayangku</b></p>'; // Nama is null
	        if(email == '') y += '<p><b>Emailnya Di Isi Dulu Sayangku</b></p>'; // Email is null
	        if(negara == '') y += '<p><b>Negaranya Di Isi Dulu Sayangku</b></p>'; // Negara is null
	        if(tahun == '') y += '<p><b>Tahunnya Di Isi Dulu Sayangku</b></p>'; // Tahun is null
	        if(gender == '') y += '<p><b>Jenis Kelaminnya Di Isi Dulu Sayangku</b></p>'; // Gender is null
